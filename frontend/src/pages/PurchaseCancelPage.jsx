	...
	return (
		<div className='min-h-screen flex items-center justify-center px-4 bg-white'>
			<motion.div
				...
				className='max-w-md w-full bg-white border border-gray-200 rounded-lg shadow-xl overflow-hidden relative z-10'
			>
				<div className='p-6 sm:p-8'>
					...
					<div className='bg-blue-50 border border-blue-100 rounded-lg p-4 mb-6'>
						<p className='text-sm text-blue-600 text-center'>
							If you encountered any issues during the checkout process, please reach out to our support team.
						</p>
					</div>
