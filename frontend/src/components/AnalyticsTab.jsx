...
const AnalyticsCard = ({ title, value, icon: Icon, color }) => (
	...
	>
		<div className='flex justify-between items-center'>
			<div className='z-10'>
				<p className='text-blue-500 text-sm mb-1 font-semibold'>{title}</p>
				<h3 className='text-blue-600 text-3xl font-bold'>{value}</h3>
			</div>
		</div>
		<div className='absolute inset-0 bg-gradient-to-br from-blue-400 to-blue-600 opacity-30' />
