...
const Navbar = () => {
	...
	return (
		<header className='fixed top-0 left-0 w-full bg-white bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-blue-500'>
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					<Link to='/' className='text-2xl font-bold text-blue-600 items-center space-x-2 flex'>
					<img src='../../logo.png' alt='ECommerce Logo' className='h-14 w-auto' />
					</Link>
					...
					<nav className='flex flex-wrap items-center gap-4'>
						...
						{user && (
							<Link
								to={"/cart"}
								className='relative group text-gray-700 hover:text-blue-600 transition duration-300 ease-in-out'
							>
